                ...
                <form>
                    <div class="mb-6">
                        <label for="name"
                            ...
                            Todo </label>
                            {{-- to bind the input with the model we use ((wire:model="the table name")) --}}
                    ...
                    {{-- to add the event on click to send the requests
                        the wire:click doesn't work inside the form so we use .prevent
                        to prevent the browser from submission
                        then we call the create method on click --}}
